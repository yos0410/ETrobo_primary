...
public class TaskManager {
    ...
    public void schedule() {// RateからDelayに変更した
        futureGame = scheduler.scheduleWithFixedDelay(gameTask, 0, 100, TimeUnit.MILLISECONDS);
        futureGame = scheduler.scheduleWithFixedDelay(gameTask, 0, 50011, TimeUnit.MILLISECONDS);
